...
上一篇文章 `使用Spring Boot Actuator监控应用`_ 介绍了Spring Boot Actuator的使用，Spring Boot Actuator提供了对单个Spring Boot的监控，信息包含：应用状态、内存、线程、堆栈等等，比较全面的监控了Spring Boot应用的整个生命周期。
...
.. _`使用Spring Boot Actuator监控应用`: 18_actuator.html

`使用spring-boot-admin对spring-boot服务进行监控`_

.. _`使用spring-boot-admin对spring-boot服务进行监控`: http://www.cnblogs.com/ityouknow/p/8440455.html
